...
## 面试技巧
 ...
 最常见的问到联系方式! 尽量避免使用非正式邮箱. 可以使用126、163、Google等类似的邮箱; 不仅可以免费长期使用而且在沟通过程中快速一笔带过，不会涉及到各自的隐私信息与兴趣爱好.

 <b>面试就像找对象，第一眼最重要。</b>其实在你面试前5分钟内基本就已经决定了这场面试是否成功。因此务必在开始时简单明了地介绍自己，流畅地描述此前公司的业务和项目流程。

 面试过程中面试者的被动状态的反应较为关键。面试官提出的问题通常而言都是他擅长的! 所以不要因为某一个点答不出就表现得很不自然，不懂装懂或迂回回答，甚至去讨好对方，要不卑不亢。
